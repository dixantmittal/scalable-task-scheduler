package com.ixigo.exception.codes.jobschedulingservice;
...
public enum ServiceExceptionCodes {
    ...
    JOB_ID_DOES_NOT_EXIST("ER-3104", "JOB ID does not exist in Scheduler. Either it was never scheduled or already executed"),
